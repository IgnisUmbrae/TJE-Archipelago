...
STATIC_ROM_PATCHES: list[tuple[int, bytes]] = [
    ...
    # "Collect" but do not add to inventory any presents ≥ 1C & auto-identify presents on pickup
    ...
    (0x0010a000, b"\x4E\x56\xFF\xF8\x48\xE7\x3E\x30\x36\x2E\x00\x0A\x2A\x2E\x00\x0C\x38\x2E\x00\x12\x30\x03\xEF"
                 ...
                 b"\xC2\x32\x06\xD1\xC0\x11\x92\x10\x00\x74\x01\x1D\x42\xFF\xFF\x4E\x71\x4E\x71\x4E\x71\x4E\x71"
                 b"\x4E\x71\x4E\xFA\x01\x8C\x2F\x0B\x4E\xB9\x00\x01\x90\x86\x4F\xEF\x00\x0C\x60\x08\x52\x46\x0C"
                 ...
                 b"\x20\x73\x74\x75\x66\x66\x65\x64\x00\x18\x12\xD8\x04\x20\x7C\x00\xff\xf3\x00\x11\xBC\x00\x01"
                 b"\x48\x01\x48\x78\x00\x32\x48\x78\x00\x01\x4E\xB9\x00\x03\xF7\x70\x4E\xFA\xFE\x56"),
    ...
    (0x0010b300, b"\x20\x7C\x00\xFF\xF5\x55\x10\xBC\x00\xFF\x20\x7C\x00\xFF\xF5\x57\x10\xBC\x00\xFF"),
    (0x0010b31e, b"\x20\x7C\x00\xFF\xF5\x58\x42\x30\x01\x50\x4E\x75"),

    # Main remote activation function

    (0x0010b100, b"\x4E\xB9\x00\x01\xC5\x2A\x60\x00\x00\x12\x60\x00\x00\xCE\x60\x00\x00\xF2\x4E\x71\x4E\xF9\x00\x00"
                 b"\x15\x3C\x22\x7C\x00\xFF\xF5\x55\x0C\x11\x00\xFF\x67\x00\x00\xA4\x0C\x11\x00\x12\x67\x2C\x12\x11"
                 b"\x48\x81\x48\xC1\x2F\x01\x22\x7C\x00\xFF\xF0\x00\x12\x11\x48\x81\x48\xC1\x2F\x01\x4E\xB9\x00\x01"
                 b"\x6E\xF4\x50\x8F\x60\x3E\x4E\x71\x4E\x71\x4E\x71\x4E\x71\x4E\x71\x4E\x71\x48\x79\x00\x00\x00\x01"
                 b"\x22\x7C\x00\xFF\xF0\x00\x12\x11\x48\x81\x48\xC1\x2F\x01\x4E\xB9\x00\x00\x8F\x3A\x50\x8F\x22\x7C"
                 b"\x00\xFF\xF0\x00\x12\x11\x48\x81\x48\xC1\x2F\x01\x4E\xB9\x00\x00\x93\xAA\x58\x8F\x0C\x00\x00\x00"
                 b"\x67\x26\x22\x7C\x00\xFF\xF5\x56\x0C\x11\x00\x01\x67\x1A\x22\x7C\x00\xFF\xF0\x00\x12\x11\x4E\x71"
                 b"\x20\x7C\x00\xFF\xA2\x4C\x54\x70\x18\x00\x4E\x71\x4E\x71\x4E\x71\x22\x7C\x00\xFF\xF5\x55\x12\xBC"
                 b"\x00\xFF\x22\x7C\x00\xFF\xF5\x56\x42\x11\x60\x00\xFF\x3E\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                 b"\x00\x00\x22\x7C\x00\xFF\xF5\x57\x0C\x11\x00\xFF\x67\x18\x12\xBC\x00\xFF\x22\x7C\x00\xFF\xF0\x00"
                 b"\x12\x11\x48\x81\x48\xC1\x2F\x01\x4E\xB9\x00\x01\xCB\x86\x60\x00\xFF\x0E\x22\x7C\x00\xFF\xF5\x58"
                 b"\x0C\x11\x00\x00\x67\x00\x00\x24\x22\x7C\x00\xFF\xF0\x00\x12\x11\x48\x81\x48\xC1\x2F\x01\x48\x78"
                 b"\x00\x3a\x4E\xB9\x00\x01\xE3\x8E\x50\x8F\x22\x7C\x00\xFF\xF5\x58\x42\x11\x4E\xF9\x00\x10\xB1\x12"),
    ...
    # Relocate dialogue table, add new entry

    (0x001050a0, b"\x03\x03\x00\x02\x69\x08\x00\x30\x00\x02\x69\x0E\x00\x01\x00\x02\x69\x19\x00\x30\x00\x02\x69\x21"
    ...
    (0x00105358, b"\x03\x02\x00\xFF\xF6\x00\x00\x20\x00\xFF\xF6\x0C"),
    (0x0001e3c0+2, b"\x00\x10\x50\xA0")
]
