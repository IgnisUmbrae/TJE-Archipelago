...
STATIC_ROM_PATCHES: list[tuple[int, bytes]] = [
    ...
    (0x0010a900, b"\x42\x41\x22\x7C\x00\xFF\xDA\xC2\x24\x7C\x00\xFF\xF3\x00\x14\x31\x10\x00\x0C\x02\x00\xFF\x67"
                 b"\x0A\x48\x82\xD4\x42\x15\xBC\x00\x01\x20\x01\x14\x31\x10\x10\x0C\x02\x00\xFF\x67\x0A\x48\x82"
                 b"\xD4\x42\x15\xBC\x00\x01\x20\x01\x06\x41\x00\x01\xB2\x7C\x00\x10\x6D\xCE\x13\xFC\x00\x1C\x00"
                 b"\xFF\xF3\x38\x13\xFC\x00\x1D\x00\xFF\xF3\x3A\x4E\x75"),
    ...
    # "Collect" but do not add to inventory any presents ≥ 1C
    ...
    (0x0010a000, b"\x4E\x56\xFF\xF8\x48\xE7\x3E\x30\x36\x2E\x00\x0A\x2A\x2E\x00\x0C\x38\x2E\x00\x12\x30\x03\xEF"
                 ...
                 b"\x8C\x42\x46\x0C\x12\x00\x1C\x6C\x00\x00\x30\x30\x03\x48\xC0\xE9\x80\x20\x7C\x00\xFF\xDA\xC2"
    ...
    (0x0010b100, b"\x4E\xB9\x00\x01\xC5\x2A\x60\x00\x00\x12\x60\x00\x00\xCE\x4E\x71\x4E\x71\x4E\x71\x4E\xF9\x00\x00"
                 ...
                 b"\x00\xFF\x22\x7C\xFF\xFF\xF5\x56\x42\x11\x60\x00\xFF\x3E\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                 b"\x00\x00\x22\x7C\x00\xFF\xF5\x57\x0C\x11\x00\xFF\x67\x18\x12\xBC\x00\xFF\x22\x7C\x00\xFF\xF0\x00"
                 b"\x12\x11\x48\x81\x48\xC1\x2F\x01\x4E\xB9\x00\x01\xCB\x86\x60\x00\xFF\x0E"),
